...
```{r setseed-split}
set.seed(1234)
all_2019_split <- initial_split(all_2019)
all_2019_train <- training(all_2019_split)
all_2019_test <- testing(all_2019_split)
```
=======
...
```
>>>>>>> 80b207c32133161e7932c1e26018f47bccd344e1
